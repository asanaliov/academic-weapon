...
{
    /// <inheritdoc />
    public partial class ExamAutopsy : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Professor = table.Column<string>(type: "TEXT", maxLength: 150, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exams_AspNetUsers_UploadedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exams_UploadedById",
                table: "Exams",
                column: "UploadedById");

            migrationBuilder.CreateIndex(
                name: "IX_Ratings_ExamId_UserId",
                table: "Ratings",
